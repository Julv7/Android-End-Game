package com.cqu.accountbook.ui.dashboard;
...
import com.cqu.accountbook.databinding.FragmentDashboardBinding;
...
public class DashboardFragment extends Fragment {
    ...
    private void refreshList() {
        new Thread(() -> {
            ...
            itemList = DatabaseAction.getInstance(getContext()).getAllIncomesDao().search(account,inOut, type, fn, tn, Integer.parseInt(yyyy), Integer.parseInt(mm), allDt);
