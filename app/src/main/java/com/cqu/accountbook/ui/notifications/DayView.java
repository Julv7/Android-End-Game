package com.cqu.accountbook.ui.notifications;
...
public class DayView extends Fragment {
    ...
    private void update(int year, int month, int dayOfMonth) {
        new Thread(() -> {
            ...
            i = DatabaseAction.getInstance(getContext()).getAllIncomesDao().dayIn(account,year, month, dayOfMonth);
            o = DatabaseAction.getInstance(getContext()).getAllIncomesDao().dayOut(account,year, month, dayOfMonth);
            db = DatabaseAction.getInstance(getContext()).getAllIncomesDao().getDayExpense(account,year, month, dayOfMonth);
